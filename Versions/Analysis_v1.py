...
# Checking Subscription End Date Pattern 
...
sub_16_demo.groupby(['Days_group'])['State'].count().plot(kind="pie" , title= "2016 Renew Data")
sub_17_demo.groupby(['Days_group'])['State'].count().plot(kind="pie" , title="2017 Renew Data")
...
sub_16_demo_ren.groupby(['Days_group'])['State'].count().plot(kind="Bar" , title= "2016 Renew Data")
sub_17_demo_ren.groupby(['Days_group'])['State'].count().plot(kind="Bar" , title= "2017 Renew Data")
